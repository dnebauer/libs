...
C<conf_dir> attribute set to true will print the configuration directory path
...
systems), but the definitive value is obtained with the C<conf_dir> attribute.
